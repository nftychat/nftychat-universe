  ...
  return /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: /*#__PURE__*/jsxRuntime.jsxs("button", {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(Icon, {
        ...
        icon: "bi:inbox"
      }), inboxNotEmpty && /*#__PURE__*/jsxRuntime.jsx("div", {
...
function DmButton(props) {
  ...
  const {
    signMessageAsync
  } = wagmi.useSignMessage(); // make sure signature requested once

  const [signedWallet, setSignedWallet] = React.useState("No wallet signed"); // Custom states
  ...
  const [showRecentMessages, setShowRecentMessages] = React.useState(false);
  const [inboxNotEmpty, setInboxNotEmpty] = React.useState(false);
  const [messageSentScreen, setMessageSentScreen] = React.useState(false); // Wallet modal
  // Connectors 0: metamask, 1:WalletConnect, 2: coinbase

  const [walletPopoverOpen, setWalletPopoverOpen] = React.useState(false); // UseEffect to warn user on error
    ...
    fetch(mainUrl + "/v1/conversations", {
      ...
      if (!response.ok) {
        response.json().then(data => {
          _t.error(data["detail"]);
          console.log(data["detail"]); // force reauth
  ...
  }, [popoverAnchor, wagmiAddress, signedWallet]); // useEffect to fetch conversations if user has authenticated
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsxs("button", {
      ...
      children: /*#__PURE__*/jsxRuntime.jsxs("div", {
        ...
        children: [(wagmiAddress === props.address || showRecentMessages) && !messageSentScreen && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
            ...
            children: [/*#__PURE__*/jsxRuntime.jsxs("span", {
              ...
              children: [" ", "View all", /*#__PURE__*/jsxRuntime.jsx(Icon, {
                className: "universal_dm__link_arrow",
                icon: "bi:arrow-right"
              })]
            })]
          })]
        }), wagmiAddress !== props.address && !showRecentMessages && !messageSentScreen && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [/*#__PURE__*/jsxRuntime.jsxs("div", {
            className: "universal_dm__content universal_dm__top",
            children: [/*#__PURE__*/jsxRuntime.jsxs("span", {
              className: "universal_dm__title",
        ...
        }), messageSentScreen && /*#__PURE__*/jsxRuntime.jsx(jsxRuntime.Fragment, {
          children: /*#__PURE__*/jsxRuntime.jsxs("div", {
      ...
      children: /*#__PURE__*/jsxRuntime.jsx("div", {
        ...
        children: connectors.map(connector => /*#__PURE__*/jsxRuntime.jsxs("button", {
