...
import DmButtonPopover from "./DmButtonPopover.js";

export default function UniversalDmInner(props) {
  // Wamgi hooks
        ...
        >
          {!authenticated ? (
            ...
            <div className="universal_dm__content universal_dm__top">
              <span className="universal_dm__title">
                {" "}
                Message {displayName}{" "}
              </span>
            </div>
                ...
                <>
                  ...
                  <div className="universal_dm__message_sent">
                    ...
                    <div className="universal_dm__message_sent__text">
                      <span className="universal_dm__message_sent__title">
                        Message sent to {displayName}
                      </span>
                      <span className="universal_dm__message_sent__subtitle">
                        Send another message or view recent messages
                      </span>
                    </div>
